    ...
    definitions: [
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            cache_creation_tokens: { type: "number", description: "Tokens written to the cache, both TTLs together." },
            cache_creation_1h_tokens: { type: "number", description: "The share of cache_creation_tokens written with a one-hour TTL, billed at 2x input instead of 1.25x." },
    ...
    handlers: {
      async record_usage(args) {
        ...
        const event = await host.usageLedger.recordUsage({
          ...
          cacheCreation1hTokens: args.cache_creation_1h_tokens,
