...
### Сессия 3.1. Импорт каталога скиллов ECC
...
### Сессия 3.2. Захват стоимости и справочник тарифов
...
### Сессия 3.3. Подготовка pull request из доказательств задачи
...
### Сессия 3.4. Линтер заявлений о завершении
