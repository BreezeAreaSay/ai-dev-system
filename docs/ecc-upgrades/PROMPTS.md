...
## Что уже сделано (на 2026-09-11, main `cec1c05`)

Сверяйтесь с этой доской перед тем, как отправлять сессию: одна сессия уже была потрачена на
повторную проверку готового пункта.
...
| 3.5 | снимки и откат состояния задачи | не начато |
| 3.6 | сканеры безопасности | не начато |
| 3.7 | правила policy и инвентарь MCP | не начато |
| 4.1, 4.2 | подготовка к Argentum | не начато |

Ближайшие невыполненные: 3.5, затем 3.6 и 3.7. Остальные позиции этапа 3 живут в
...
### Сессия 3.5. Снимки и откат состояния задачи
