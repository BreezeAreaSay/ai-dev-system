...
Все поддерживаемые способы установки — от одной команды до сборки образа
вручную. Если нужно просто начать, хватит трёх команд из
[README](../../README.ru.md#установка).
